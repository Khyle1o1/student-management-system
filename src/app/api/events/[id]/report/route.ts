...
async function generateEventReportPDF(event: any, attendanceData: any, stats: any, eligibleStudents: any[], adminName: string): Promise<Buffer> {
  try {
...
export async function GET(
  ...
  try {
    ...
    try {
      ...
      const pdfBuffer = await generateEventReportPDF(event, uniqueStudentRecords || [], stats, eligibleStudents || [], adminName)
